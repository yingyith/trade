...
getBidAskNum apr dpdata = [
                           ...
                           (sum $ DHM.elems $  DHM.filterWithKey  (getbiddiffquanpred (snd apr) 0.0003 ) $ bidset  dpdata ,
                           sum $ DHM.elems $  DHM.filterWithKey  (getaskdiffquanpred  (snd apr) 0.0003 ) $ askset  dpdata 
                           ),
                           ...
                           (sum $ DHM.elems $  DHM.filterWithKey  (getbiddiffquanpred (snd apr) 0.001 ) $ bidset  dpdata ,
                           sum $ DHM.elems $  DHM.filterWithKey  (getaskdiffquanpred  (snd apr) 0.001 ) $ askset  dpdata 
                           ),
                           (sum $ DHM.elems $  DHM.filterWithKey  (getbiddiffquanpred (snd apr) 0.0025 ) $ bidset  dpdata ,
                           sum $ DHM.elems $  DHM.filterWithKey  (getaskdiffquanpred  (snd apr) 0.0025 ) $ askset  dpdata 
                           ),
