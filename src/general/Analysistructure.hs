...
getBidAskNum apr dpdata = [
                           ...
                           (sum $ DHM.elems $  DHM.filterWithKey  (getbiddiffquanpred (snd apr) 0.0009 ) $ bidset  dpdata ,
                           sum $ DHM.elems $  DHM.filterWithKey  (getaskdiffquanpred  (snd apr) 0.0009 ) $ askset  dpdata 
                           ),
                           ...
                           (sum $ DHM.elems $  DHM.filterWithKey  (getbiddiffquanpred (snd apr) 0.009 ) $ bidset  dpdata ,
                           sum $ DHM.elems $  DHM.filterWithKey  (getaskdiffquanpred  (snd apr) 0.009 ) $ askset  dpdata 
                           ),
                           (sum $ DHM.elems $  DHM.filterWithKey  (getbiddiffquanpred (snd apr) 0.02 ) $ bidset  dpdata ,
                           sum $ DHM.elems $  DHM.filterWithKey  (getaskdiffquanpred  (snd apr) 0.02 ) $ askset  dpdata 
                           ),
                           (sum $ DHM.elems $  DHM.filterWithKey  (getbiddiffquanpred (snd apr) 0.08 ) $ bidset  dpdata ,
                           sum $ DHM.elems $  DHM.filterWithKey  (getaskdiffquanpred  (snd apr) 0.08 ) $ askset  dpdata 
                           ),
                           (0 ,
                            0 
                           )]
