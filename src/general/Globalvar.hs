...
depthrisksheet          :: [Int] 
depthrisksheet          = [-3000  ,350   ,610   ,1010   ,1710  ,1860  ,2050  ,2300 ]   --deothrisksheet x 2  = minrulethreshold + shortminrulethreshold 
...
adjustboostgrid         =  [(0,300) ,(400,400)   ,(1200,1200)   , (1600,2500), (2510,3000)  ,(3000,4000) , (4000,5000)               ]
