...
diffspreadsheet         = [0.24   ,0.45  ,0.61  ,0.75  ,0.81  ,0.88  ,0.95  ,1] 

depthrisksheet          :: [Int] 
depthrisksheet          = [300   ,710   ,910   ,1010  ,1260  ,1410  ,2100 ]   --deothrisksheet x 2  = minrulethreshold + shortminrulethreshold 
