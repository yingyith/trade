...
crossminstra abc pr = do 
    ...
    -- 3m need a distance 
    let lowpointpred = ((snd $ snd $  fst $ (!!0) abc )  <= (snd $ snd $  fst $ (!!2) abc))|| ((pr-0.001)< (snd $ snd $  fst $ (!!2) abc))
    let highpointpred = ((fst $ snd $  fst $ (!!0) abc ) >= (fst $ snd $  fst $ (!!2) abc))|| ((pr+0.001)> (fst $ snd $  fst $ (!!2) abc))
